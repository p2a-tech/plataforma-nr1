...
export const navItems: NavItem[] = [
  ...
  { href: "/conformidade/acoes", label: "Plano de ação", icon: ClipboardCheck, ator: "ia", descricao: "Plano de ação NR-1 · acompanhamento" },
  { href: "/conformidade/prontidao", label: "Prontidão p/ auditoria", icon: Gauge, ator: "ia", descricao: "Prontidão para auditoria" },
