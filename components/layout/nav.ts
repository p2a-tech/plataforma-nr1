...
export const navItems: NavItem[] = [
  ...
  { href: "/clinica", label: "Portal da Clínica", icon: HeartPulse, ator: "clinica", descricao: "Visão do parceiro", papeis: ["sst", "clinica", "admin"] },
  { href: "/atendimento", label: "Atendimento + IA", icon: FileAudio, ator: "clinica", descricao: "Transcrição → análise da IA", papeis: ["sst", "clinica", "admin"] },
